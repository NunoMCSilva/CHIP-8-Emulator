# TODO: separate to opcodes for better testing?
# TODO: needs a recheck
import pytest
...
class TestVirtualMachineStep:
    ...
    def test_opcode_00ee__returns_from_subroutine(self, vm):
        ...
        assert vm.pc == 0x302   # needs to go to next instruction
    ...
    @pytest.mark.skip("until I get wait for keypress to work better with GUI")
